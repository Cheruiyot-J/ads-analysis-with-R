...
4.Most users do not click ad despite spending more time on site.
5.Countries with the highest number of users that clicked Ad were; Australia, Ethiopia, Turkey, Liberia , Liechtenstein and South Africa
6.Cities with most users that click Ad are; Lake David, Lake James, Lisamouth, Michelleside, Millerbury and Robertfurt.
7. The age with the highest number of Ad clicks is 45, followed by 25 and 38.
